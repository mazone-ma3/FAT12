...
#define AH 0x76
#define DA_UA 0x10 //90


/* PC-98 720KB用パラメータ */
#define ROOTDIR_LBA	7	// ルートディレクトリ開始LBA
#define ROOTDIR_NUM	7
#define DATA_LBA	14	// データ開始LBA
...
/* PC-98 BIOS 720KB読み込み（INT 1Bh AH=22h） */
...
//	printf("read lba %d sect %d head %d cyl %d\n", lba, sect, head, cyl);
	...
	regs.x.bx = SECTSIZE;
	regs.x.cx = ((2 << 8) & 0xff00) | (cyl & 0x00ff);
